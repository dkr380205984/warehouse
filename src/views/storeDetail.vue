            ...
            <div class="tbody">
              <div class="trow">
                <div class="tcolumn">ABC123456
                  <span style="cursor:pointer;color:#1a95ff">(新增尺码配色)</span>
                </div>
                <div class="tcolumn">产品名称/款号</div>
                <div class="tcolumn">产品图片</div>
                <div class="tcolumn noPad"
            ...
            <div class="createModule"
              ...
              <div class="rowCtn">
                ...
                <div class="colCtn">
                  ...
                  <div class="content">
                    <span class="spanInput"> {{totalPrice(item.children)}}</span>
                  </div>
                </div>
                <div class="colCtn">
                  <div class="label">
    ...
    <div class="module">
      ...
      <div class="listCtn">
        <div class="filterCtn">
          ...
          <div class="leftCtn">
            <div class="btn noBorder">批量删除</div>
...
<script>
import { getToken, stock } from '@/assets/js/api.js'
export default {
  data () {
    return {
      createProFlag: false,
