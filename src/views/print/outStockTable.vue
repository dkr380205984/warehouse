  ...
  <div id='goStockTable'
    ...
    <div class="printTable crosswise">
      ...
      <div class="print_body">
        <div class="print_row">
          <div class="row_item center">出库时间</div>
          ...
          <div class="row_item right">数量</div>
          <div class="row_item right">件数</div>
          <div class="row_item left">出库款号</div>
          <div class="row_item left">出库单位</div>
        </div>
        <div class="print_row"
...
export default {
  data () {
    return {
      title: window.sessionStorage.getItem('company_name') + '物料出库单',
      ...
      yarnOrder.detail({
        ...
        if (res.data.status !== false) {
          ...
          if (logIdArr) {
            ...
            this.logInfo = data.stock_log.filter(itemF => itemF.action_type === 2)
          }
          setTimeout(() => {
            window.print()
          }, 1000)
